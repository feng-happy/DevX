...
/**
 * @author CZF
 * @create 2024-08-25 23:59
 */
public class CallMethodOpenAction extends AnAction {

    private static final Logger log = Logger.getInstance(CallMethodOpenAction.class);
    ...
    public void actionPerformed(@NotNull final AnActionEvent e) {
        ...
        try {
            ...
            new CallMethodPerformed().invoke(project, finalPsiMethod, () -> CallMethodAgainOpenAction.PRE_METHOD_MAP.put(project.getName(), finalPsiMethod));
